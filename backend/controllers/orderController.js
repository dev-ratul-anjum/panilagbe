...
exports.createOrder = async (req, res) => {
  ...
  if(paymentMethod === 'cash'){
    ...
    const data = {
      ...
      success_url: `${process.env.FRONTEND_URL}/api/orders/checkout/success/${tran_id}`,
      fail_url: `${process.env.FRONTEND_URL}/api/orders/checkout/fail/${tran_id}`,
      cancel_url: `${process.env.FRONTEND_URL}/api/orders/checkout/cancel/${tran_id}`,
      ipn_url: `${process.env.FRONTEND_URL}/api/orders/checkout/ipn/${tran_id}`,
...
exports.payOrderPayment = async (req, res) => {
  ...
  const data = {
    ...
    currency: 'BDT',
    tran_id: tran_id, // use unique tran_id for each api call
    success_url: `${process.env.FRONTEND_URL}/api/orders/payment/checkout/success/${tran_id}`,
    fail_url: `${process.env.FRONTEND_URL}/api/orders/checkout/fail/${tran_id}`,
    cancel_url: `${process.env.FRONTEND_URL}/api/orders/checkout/cancel/${tran_id}`,
    ipn_url: `${process.env.FRONTEND_URL}/api/orders/checkout/ipn/${tran_id}`,
    shipping_method: 'Courier',
